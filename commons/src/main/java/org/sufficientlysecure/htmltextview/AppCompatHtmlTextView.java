...
public class AppCompatHtmlTextView extends AppCompatJellyBeanSpanFixTextView {
    ...
    public AppCompatHtmlTextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public AppCompatHtmlTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AppCompatHtmlTextView(Context context) {
        super(context);
    }

    /**
     * @see AppCompatHtmlTextView#setHtml(int)
     */
    ...
    /**
     * @see AppCompatHtmlTextView#setHtml(String)
     */
