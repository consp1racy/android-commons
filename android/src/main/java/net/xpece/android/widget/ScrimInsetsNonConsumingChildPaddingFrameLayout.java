...
public class ScrimInsetsNonConsumingChildPaddingFrameLayout extends FrameLayout {
    ...
    public ScrimInsetsNonConsumingChildPaddingFrameLayout(Context context) {
        this(context, null);
    }

    public ScrimInsetsNonConsumingChildPaddingFrameLayout(Context context, AttributeSet attrs) {
