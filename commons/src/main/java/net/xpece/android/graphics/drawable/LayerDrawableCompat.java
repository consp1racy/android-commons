...
//        return (mLayerState != null && mLayerState.canApplyTheme()) || super.canApplyTheme();
    ...
    public boolean getPadding(Rect padding) {
        ...
        // padding.
        final boolean isLayoutRtl = DrawableCompat.getLayoutDirection(this) == ViewCompat.LAYOUT_DIRECTION_RTL;
    ...
    static class LayerState extends ConstantState {
        ...
        LayerState(@Nullable LayerState orig, @NonNull LayerDrawableCompat owner,
                   @Nullable Resources res) {
            mDensity = DrawableInternal.resolveDensity(res, orig != null ? orig.mDensity : 0);
