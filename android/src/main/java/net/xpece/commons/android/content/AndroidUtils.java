package net.xpece.commons.android.content;
...
public class AndroidUtils {
  ...
  public static int getColumnCount(Context context) {
    if (!API_13) {
      ...
      if (screenSize == Configuration.SCREENLAYOUT_SIZE_SMALL) return 1;
...
//    if (screenWidthDp > 820) return 4;
  ...
  public static boolean isRtl(Context context) {
    return Build.VERSION.SDK_INT >= 17 && context.getResources().getConfiguration().getLayoutDirection() == ViewCompat.LAYOUT_DIRECTION_RTL;
  }
