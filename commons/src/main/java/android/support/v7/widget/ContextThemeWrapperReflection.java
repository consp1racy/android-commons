 ...
 * or {@link android.support.v7.view.ContextThemeWrapper}.
 * <p>
...
class ContextThemeWrapperReflection {
    ...
    static {
        ...
        try {
            f = android.support.v7.view.ContextThemeWrapper.class.getDeclaredField("mThemeResource");
            f.setAccessible(true);
        } catch (NoSuchFieldException e) {
    ...
    static boolean isSupportContextThemeWrapper(Object context) {
        return ContextThemeWrapperReflection.hasAppCompat() &&
            context instanceof android.support.v7.view.ContextThemeWrapper;
    }
    ...
    public static int getThemeResource(final android.support.v7.view.ContextThemeWrapper context) {
        try {
    ...
    public static int getThemeResource(final Object context) {
        if (context instanceof android.view.ContextThemeWrapper) {
            ...
            return getThemeResource((android.support.v7.view.ContextThemeWrapper) context);
        } else {
            return 0;
        }
    }
