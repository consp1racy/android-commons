 ...
 */
public class XpAppCompatEditText extends EditText
    ...
    public XpAppCompatEditText(Context context) {
        this(context, null);
    }

    public XpAppCompatEditText(Context context, AttributeSet attrs) {
        this(context, attrs, android.support.v7.appcompat.R.attr.editTextStyle);
    }

    public XpAppCompatEditText(Context context, AttributeSet attrs, int defStyleAttr) {
