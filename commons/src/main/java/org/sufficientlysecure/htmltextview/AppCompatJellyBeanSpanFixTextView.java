...
public class AppCompatJellyBeanSpanFixTextView extends AppCompatTextView {
    ...
    public AppCompatJellyBeanSpanFixTextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public AppCompatJellyBeanSpanFixTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AppCompatJellyBeanSpanFixTextView(Context context) {
        super(context);
    }
