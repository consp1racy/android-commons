 ...
 * alternative is via the {@link net.xpece.android.widget.SlidingTabLayout.TabColorizer} interface which provides you complete control over
...
//    addView(mTabStrip, LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
  ...
  /**
   * Set the custom {@link net.xpece.android.widget.SlidingTabLayout.TabColorizer} to be used.
   * <p/>
  ...
  /**
   * Set the {@link android.support.v4.view.ViewPager.OnPageChangeListener}. When using {@link net.xpece.android.widget.SlidingTabLayout} you are
