 ...
 * alternative is via the {@link net.xpece.commons.android.widget.SlidingTabLayout.TabColorizer} interface which provides you complete control over
...
//    addView(mTabStrip, LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
  ...
  public int getTabViewPadding() {
    return mTabViewPadding;
  }
  ...
  /**
   * Set the custom {@link net.xpece.commons.android.widget.SlidingTabLayout.TabColorizer} to be used.
   * <p/>
  ...
  /**
   * Set the {@link android.support.v4.view.ViewPager.OnPageChangeListener}. When using {@link net.xpece.commons.android.widget.SlidingTabLayout} you are
...
//    textView.setTextSize(TypedValue.COMPLEX_UNIT_SP, TAB_VIEW_TEXT_SIZE_SP);
    ...
    textView.setPadding(mTabViewPadding, mTabViewPadding, mTabViewPadding, mTabViewPadding);
