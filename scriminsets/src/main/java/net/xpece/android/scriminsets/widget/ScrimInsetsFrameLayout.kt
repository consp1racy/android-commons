...
/**
 * A [FrameLayout] with the ability to scrim window insets.
 *
...
constructor(
    ...
    @AttrRes defStyleAttr: Int = R.attr.scrimInsetsFrameLayoutStyle,
    @StyleRes defStyleRes: Int = R.style.Widget_Xpece_ScrimInsetsFrameLayout
