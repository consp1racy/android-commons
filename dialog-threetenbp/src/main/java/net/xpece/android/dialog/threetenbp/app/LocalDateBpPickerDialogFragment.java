...
public class LocalDateBpPickerDialogFragment extends AppCompatDialogFragment implements
    ...
    @NonNull
    public static LocalDateBpPickerDialogFragment newInstance(@Nullable final LocalDate date) {
        return newInstance(date, null, null);
    }

    @NonNull
    public static LocalDateBpPickerDialogFragment newInstanceWithMax(@Nullable final LocalDate date, @Nullable final LocalDate max) {
        return newInstance(date, null, max);
    }

    @NonNull
    public static LocalDateBpPickerDialogFragment newInstanceWithMin(@Nullable final LocalDate date, @Nullable final LocalDate min) {
        return newInstance(date, min, null);
    }

    @NonNull
    public static LocalDateBpPickerDialogFragment newInstance(@Nullable final LocalDate date, @Nullable final LocalDate min, @Nullable final LocalDate max) {
    ...
    public interface Callbacks {
        void onDateSelected(@NonNull LocalDateBpPickerDialogFragment fragment, @NonNull LocalDate date);

        void onCancel(@NonNull LocalDateBpPickerDialogFragment fragment);
    }
}
