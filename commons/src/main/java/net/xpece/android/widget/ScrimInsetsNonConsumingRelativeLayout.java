...
public class ScrimInsetsNonConsumingRelativeLayout extends IrresponsibleRelativeLayout {
    ...
    public ScrimInsetsNonConsumingRelativeLayout(final Context context) {
        this(context, null);
    }

    public ScrimInsetsNonConsumingRelativeLayout(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    @SuppressWarnings("RestrictedApi")
    public ScrimInsetsNonConsumingRelativeLayout(final Context context, final AttributeSet attrs, final int defStyleAttr) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this,
            new android.support.v4.view.OnApplyWindowInsetsListener() {
                ...
                public WindowInsetsCompat onApplyWindowInsets(View v, WindowInsetsCompat insets) {
                    ...
                    ViewCompat.postInvalidateOnAnimation(ScrimInsetsNonConsumingRelativeLayout.this);
